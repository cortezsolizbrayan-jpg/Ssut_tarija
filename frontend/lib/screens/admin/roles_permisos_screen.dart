...
class RolesPermisosScreen extends StatefulWidget {
  ...
  const RolesPermisosScreen({super.key, this.initialUserId});
...
class _RolesPermisosScreenState extends State<RolesPermisosScreen> {
  ...
  void _showCrearUsuarioDialog() async {
  ...
  void _showPermissionsDialog(Usuario usuario) {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => PermisosUsuarioDialog(
        userId: usuario.id,
