...
class PermisosUsuarioDialog extends StatefulWidget {
  final int userId;
  final String userName;

  const PermisosUsuarioDialog({
    super.key,
  ...
  @override
  State<PermisosUsuarioDialog> createState() => _PermisosUsuarioDialogState();
}

class _PermisosUsuarioDialogState extends State<PermisosUsuarioDialog> {
