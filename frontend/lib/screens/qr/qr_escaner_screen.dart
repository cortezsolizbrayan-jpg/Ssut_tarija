...
import 'components/escaner_movil_widget.dart';

class QREscanerScreen extends StatefulWidget {
  const QREscanerScreen({super.key});

  @override
  State<QREscanerScreen> createState() => _QREscanerScreenState();
}

class _QREscanerScreenState extends State<QREscanerScreen>
