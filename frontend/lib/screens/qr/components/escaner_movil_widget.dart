...
class EscanerMovilWidget extends StatefulWidget {
  final Function(String) onDetect;

  const EscanerMovilWidget({super.key, required this.onDetect});

  @override
  State<EscanerMovilWidget> createState() => _EscanerMovilWidgetState();
}

class _EscanerMovilWidgetState extends State<EscanerMovilWidget> {
