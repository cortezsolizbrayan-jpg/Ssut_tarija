...
class DocumentoBusquedaScreen extends StatefulWidget {
  final String? query;

  const DocumentoBusquedaScreen({super.key, this.query});

  @override
  State<DocumentoBusquedaScreen> createState() => _DocumentoBusquedaScreenState();
}

class _DocumentoBusquedaScreenState extends State<DocumentoBusquedaScreen> {
                                ...
                                child: ListTile(
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder:
                                            (context) => DocumentoDetalleScreen(
                                              documento: doc,
                                            ),
                                      ),
                                    );
