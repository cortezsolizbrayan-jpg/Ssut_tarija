...
class OlvideContrasenaAdminScreen extends StatefulWidget {
  const OlvideContrasenaAdminScreen({super.key});

  @override
  State<OlvideContrasenaAdminScreen> createState() => _OlvideContrasenaAdminScreenState();
}

class _OlvideContrasenaAdminScreenState extends State<OlvideContrasenaAdminScreen> {
