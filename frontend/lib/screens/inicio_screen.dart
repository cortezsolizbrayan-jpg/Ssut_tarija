...
import 'admin/roles_permisos_screen.dart';
import 'configurar_pregunta_secreta_screen.dart';
import 'documentos/documento_busqueda_screen.dart';
...
import 'qr/qr_escaner_screen.dart';
    ...
    if (authProvider.canManageUserPermissions) {
      _navItems.add(
        NavigationItem(
          ...
          screen: const RolesPermisosScreen(),
        ),
      );
    }
      ...
      child: IconButton(
        ...
        onPressed: () {
          if (tooltip == 'Notificaciones') {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const DocumentoBusquedaScreen()),
            );
          }
        },
        tooltip: tooltip,
