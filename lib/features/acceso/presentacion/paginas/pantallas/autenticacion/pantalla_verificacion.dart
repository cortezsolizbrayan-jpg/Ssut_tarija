...
class VerificationPantalla extends StatefulWidget {
  static const name = 'verification-Pantalla';
  final String target; // El número de celular o correo ingresado

  const VerificationPantalla({super.key, required this.target});

  @override
  State<VerificationPantalla> createState() => _VerificationPantallaState();
}

class _VerificationPantallaState extends State<VerificationPantalla> {
