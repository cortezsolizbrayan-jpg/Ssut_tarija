...
import 'package:refactor_template/core/services/ocr/servicio_ocr_blinkid.dart';
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          // BlinkID y Scanbot DESHABILITADOS para reducir tamaño de app
          
          _buildScanOption(
            context: context,
            title: 'OCR ML Kit avanzado',
            subtitle: 'Reconocimiento de texto mejorado con preprocesamiento (Recomendado)',
