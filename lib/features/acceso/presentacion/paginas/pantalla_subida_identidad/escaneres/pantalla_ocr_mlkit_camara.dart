...
class MlKitOcrCameraPantalla extends StatefulWidget {
  /// true = anverso, false = reverso
  final bool isFront;
  /// Si true (reverso), muestra botón "Omitir reverso"
  final bool showSkipButton;

  const MlKitOcrCameraPantalla({
    super.key,
  ...
  @override
  State<MlKitOcrCameraPantalla> createState() => _MlKitOcrCameraPantallaState();
}

class _MlKitOcrCameraPantallaState extends State<MlKitOcrCameraPantalla>
