...
class IdCaptureCameraScreen extends StatefulWidget {
  /// true = anverso, false = reverso
  final bool isFront;

  const IdCaptureCameraScreen({super.key, required this.isFront});

  @override
  State<IdCaptureCameraScreen> createState() => _IdCaptureCameraScreenState();
}

class _IdCaptureCameraScreenState extends State<IdCaptureCameraScreen> {
