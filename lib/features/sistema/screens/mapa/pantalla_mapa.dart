...
class MapaPantalla extends ConsumerStatefulWidget {
  const MapaPantalla({super.key});

  @override
  ConsumerState<MapaPantalla> createState() => _MapaPantallaState();
}

class _MapaPantallaState extends ConsumerState<MapaPantalla>
  ...
  final List<Map<String, dynamic>> _locations = [
    {
      ...
      'lng': -68.1633,
      'tipo': 'Sede Principal',
      'programas': ['DIPLOMADO', 'MAESTRÃA', 'DOCTORADO'],
    ...
    },
    {
      ...
      'horario': '24/7 - Acceso en lÃ­nea',
      'url': 'https://posgradouap.edu.bo',
    },
    {
      'nombre': 'Centro de ExtensiÃ³n La Paz',
  ...
  Widget _buildLocationFilters() {
    final tipos = ['Todas', 'Sede Principal', 'Virtual', 'ExtensiÃ³n'];
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return TweenAnimationBuilder<double>(
                      ...
                      curve: Curves.easeOut,
                      builder: (context, animValue, hijo) {
                        return Opacity(
                          opacity: animValue,
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    ...
                                    // Reiniciar animaciÃ³n de marcadores
          ...
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                ...
                // Marcadores de ubicaciÃ³n animados
                ...filteredLocations.asMap().entries.map((entry) {
                  final index = entry.key;
                  final location = entry.value;
                  // Distribuir marcadores de forma mÃ¡s inteligente
  ...
  void _showLocationDetails(Map<String, dynamic> location) {
    showModalBottomSheet(
      ...
      // Usar animaciÃ³n de lista del controller maestro
  ...
  Future<void> _openInMaps(List<Map<String, dynamic>> locations) async {
    ...
    // Si hay una sola ubicaciÃ³n, abrir esa
    if (locations.length == 1) {
      ...
      // Si hay mÃºltiples, abrir con todas las ubicaciones
      final centerLat =
...
class _AnimatedMarkerState extends State<_AnimatedMarker>
  ...
  void initState() {
    ...
    // Iniciar animaciÃ³n despuÃ©s del delay
