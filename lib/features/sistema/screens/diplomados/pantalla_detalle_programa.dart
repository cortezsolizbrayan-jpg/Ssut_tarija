...
class DetalleProgramaPantalla extends StatefulWidget {
  ...
  @override
  State<DetalleProgramaPantalla> createState() => _DetalleProgramaPantallaState();
}

class _DetalleProgramaPantallaState extends State<DetalleProgramaPantalla>
  ...
  Widget _buildContent() {
    return Scaffold(
      backgroundColor: const Color(0xFF005BAC), // Color institucional para barra superior
      body: SafeArea(
        bottom: false,
        top: false,
        child: Column(
          children: [
            // Header azul (degradé + iconos)
            _buildHeader(),
            // Sección desplazable y blanca
            Expanded(
              child: Container(
                color: Theme.of(context).scaffoldBackgroundColor,
                child: Column(
                  children: [
                    // Indicadores de página estilo Filtros/Tabs
                    _buildTabs(),
  ...
  Widget _buildHeader() {
    final headerHPad = ResponsiveUtils.horizontalPadding(context);
    final titleSize = ResponsiveUtils.titleFontSize(context);
    final subtitleSize = ResponsiveUtils.bodyFontSize(context);
    final actionButtonSize = ResponsiveUtils.scale(context, 44);
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(
        headerHPad,
        ResponsiveUtils.scale(context, 32) + MediaQuery.of(context).padding.top,
        headerHPad,
        ResponsiveUtils.scale(context, 24),
      ),
      child: Column(
          ...
          FadeInDown(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Container()), // Espacio flexible
                // Avatar
                Builder(
  ...
  /// Navegación visual y clara tipo Pestañas/Filtros
  Widget _buildTabs() {
    final hPad = ResponsiveUtils.horizontalPadding(context);
    final vPad = ResponsiveUtils.scale(context, 12);
    final chipFont = ResponsiveUtils.bodyFontSize(context);
    final tabs = ['Notas', 'Matrículas', 'Pagos', 'Documentos'];
    return Container(
          ...
          children: List.generate(tabs.length, (index) {
            ...
            return Padding(
              ...
              child: ActionChip(
                ...
                backgroundColor: isSelected ? const Color(0xFF005BAC) : Colors.grey.shade100,
                onPressed: () {
                          ...
                          child: AnimatedContainer(
                            ...
                            child: LayoutBuilder(
                              builder: (context, constraints) {
                                ...
                                final PantallaWidth = MediaQuery.of(
                                  context,
                                ).size.width;
                                final fontSize = math
                                    .max(
                                      10.0,
                                      math.min(13.0, PantallaWidth * 0.03),
                                    )
                                    .toDouble();
                                final iconSize = math
                                    .max(
                                      14.0,
                                      math.min(18.0, PantallaWidth * 0.04),
                                    )
                                    .toDouble();
                                final paddingH = math
                                    .max(
                                ...
                                final paddingV = math
                                    .max(
                                      6.0,
                                      math.min(10.0, PantallaWidth * 0.023),
                                    )
                                    .toDouble();
                                ...
                                return FittedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      ...
                                      minimumSize: Size(
                                        0,
                                        math.max(36, PantallaWidth * 0.085),
                                      ),
                                    ),
                                  ),
                                );
  ...
  void _showMisMatriculasPantalla() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
  ...
  void _showMisDocumentosPantalla() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
