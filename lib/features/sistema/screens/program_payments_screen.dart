...
import 'package:refactor_template/features/sistema/widgets/custom_cards.dart';

/// Pantalla de demostración de las tarjetas personalizadas
class ProgramPaymentsScreen extends StatefulWidget {
  static const String name = 'program-payments';
  
  const ProgramPaymentsScreen({super.key});

  @override
  State<ProgramPaymentsScreen> createState() => _ProgramPaymentsScreenState();
}

class _ProgramPaymentsScreenState extends State<ProgramPaymentsScreen> {
